  ...
  <div id="form-sections">
    ...
    <ul>
      <li>
        ...
        vision for their team, aligned with the Corporate Plan for the BC Public
        Service
      </li>
      <li>
        Ability to establish trust, motivate, empower and receive high
        satisfaction ratings from their employees
      </li>
    ...
    <EvaluationsFieldset>
      ...
      <template v-slot:complexity_overview>
        ...
        <ul>
          <li>
            Size of the organization, project, process or initiative managed
          </li>
          <li>
            Ability to manage complex situations including large-scale
            initiatives, manage and mitigate risks, solve problems creatively
      ...
      <template v-slot:valuing_people_overview>
        ...
        <ul>
          ...
          <li>
            Championing employee recognition and collaborative team-based
            environments
          </li>
          <li>
          ...
          <li>
            ...
            intent and effort, accepting failure by not casting blame but rather
            learning from it, improving and moving forward
          </li>
        </ul>
      </template>
      ...
      <template v-slot:impact_overview>
        ...
        <ul>
          ...
          <li>
            ...
            in the improvement of workplace processes such as reducing costs or
