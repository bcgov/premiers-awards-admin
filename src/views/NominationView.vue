<template>
  ...
  <div class="grid">
    ...
    <div class="col-12 md:col-9">{{settings.lookup('categories', selected.category)}}</div>
    <div class="col-12 md:col-3"><b>Status</b></div>
    <div class="col-12 md:col-9">
      <Tag v-if="selected.submitted" severity="success" icon="pi pi-lock" rounded>Submitted</Tag>
      <Tag v-else severity="warning" icon="pi pi-unlock" rounded>Draft</Tag>
    </div>
    <div class="col-12 md:col-3"><b>Owner</b></div>
    <div class="col-12 md:col-9">
      {{selected.owner && selected.owner.hasOwnProperty('username') ? selected.owner.username : '-'}}
    </div>
    <div class="col-12 md:col-3"><b>Acknowledgment</b></div>
    <div class="col-12 md:col-9">
      <Tag v-if="selected.acknowledgment" severity="success" icon="pi pi-check" rounded>Accepted</Tag>
      <Tag v-else severity="warning" icon="pi pi-times" rounded>Not Accepted</Tag>
    </div>
      ...
      <div class="grid">
        <div class="col-12 md:col-6">
          ...
          <div class="grid">
            ...
            <div class="col-12 md:col-9">{{selected.contacts.primary.lastname}}</div>
            <div class="col-12 md:col-3">Email</div>
            <div class="col-12 md:col-9">{{selected.contacts.primary.email}}</div>
            <div class="col-12 md:col-3">Phone</div>
            <div class="col-12 md:col-9">{{selected.contacts.primary.phone}}</div>
          </div>
        </div>
        <div class="col-12 md:col-6">
          <h4>Video</h4>
          <div class="grid">
            <div class="col-12 md:col-3">First Name</div>
            <div class="col-12 md:col-9">{{selected.contacts.video.firstname}}</div>
            <div class="col-12 md:col-3">Last Name</div>
            <div class="col-12 md:col-9">{{selected.contacts.video.lastname}}</div>
            <div class="col-12 md:col-3">Email</div>
            <div class="col-12 md:col-9">{{selected.contacts.video.email}}</div>
            <div class="col-12 md:col-3">Phone</div>
            <div class="col-12 md:col-9">{{selected.contacts.video.phone}}</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-12">
      ...
      >
        ...
        <Column field="label" header="Metadata" :sortable="true" style="width: 23rem;">
          <template #body="{data}">
            <div><b>{{ data.label || '(No Label)' }}</b></div>
